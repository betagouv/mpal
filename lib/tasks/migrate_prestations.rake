...
task migrate_prestations: :environment do
  new_prestation_names = [
    ...
    "Chaudière gaz à condension",
    "Chaudière gaz basse température",
    "Radiateurs gaz",
    "Chaudière fuel simple",
    "Chaudière fuel à condension",
    ...
    "Instalation d'un monte escalier",
    "Instalation d'un ascenseur  ",
    "Instalation d'un monte personne ou plate forme forme élévatrice",
    ...
    "Instalation ou mise aux normes d'un assainissement individuel",
    ...
    "Plomberie sanitaires : Autres Choix",
    ...
    "Création d'un local vélo / poussettes",
