...
private
  ...
  def needs_next_step?
    (@projet_courant.contacted_operateur.blank? && @projet_courant.invited_pris.blank? && !(ENV['ELIGIBLE_HMA'] == "true" && @projet_courant.demande.seul)) || @projet_courant.eligibilite == 1
  end
