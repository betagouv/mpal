module ApplicationHelper
  ...
  def icone_evenement(label)
    liste_icone = {choix_intervenant: 'pin', creation_projet: 'suitcase', invitation_intervenant: 'plug', mise_en_relation_intervenant: 'plug', ajout_avis_imposition: "file text outline" }
