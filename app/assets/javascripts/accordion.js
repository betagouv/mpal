...
/*
Below is the code from accordion.js
        ...
        $allModules.each(function () {
            ...
            module = {
                    ...
                    if (!$activeContent.is(':animated')) {
                        ...
                        if (settings.exclusive && contentIsOpen) {
                            ...
                            $previousContent.stop()
                                ...
                                $previousContent.removeClass(className.active)
                                    .attr('style', '')
                                    .removeAttr('style')
                                    .children()
                                    .attr('style', '')
                ...
                close: function (index) {
                    ...
                    $activeContent.removeClass(className.active)
                        .show()
                        .stop()
                        .children()
                        .animate({
