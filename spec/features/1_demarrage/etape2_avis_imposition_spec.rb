...
feature "Avis d'imposition :" do
  ...
  context "en tant que demandeur avec aucun avis d'imposition rajouté" do
    scenario "je peux ajouter un avis d'imposition" do
  ...
  context "en tant que demandeur avec 1 avis d'imposition rajouté" do
    ...
    scenario "je peux supprimer un avis d'imposition" do
      signin(projet.numero_fiscal, projet.reference_avis)
      visit projet_avis_impositions_path(projet)
