...
feature "En tant que demandeur, un PRIS est automatiquement assigné à mon projet" do
  ...
  context "quand je ne suis pas éligible" do
    ...
    scenario "je suis notifié de ma non éligibilité" do
      ...
      visit etape3_mise_en_relation_path(projet)
      expect(page).to have_content(I18n.t('demarrage_projet.etape3_mise_en_relation.votre_projet_est_non_eligible'))
      expect(page).to have_content(I18n.t('demarrage_projet.etape3_mise_en_relation.non_eligible_recontacter',  { pris: pris.raison_sociale}))
    end
  end
end
