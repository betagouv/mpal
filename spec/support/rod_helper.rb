...
module Fakeweb
  class Rod
    ...
    }.freeze.merge(other_intervenants)

    def self.list_department_intervenants_helper
      FakeWeb.register_uri(
        :get, %r|#{ENV['ROD_API_BASE_URI']}intpardpt/|,
        body: JSON.generate(FakeResponseList),
        status: [200, "OK"]
      )
    end
...
#TODO : virer du global et voir où elle est utilisée
